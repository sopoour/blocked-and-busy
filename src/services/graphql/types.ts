...
export type AssetLinkingCollections = {
  ...
  newsletterPostCollection?: Maybe<NewsletterPostCollection>;
};
...
export type AssetLinkingCollectionsNewsletterPostCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<AssetLinkingCollectionsNewsletterPostCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};

export enum AssetLinkingCollectionsNewsletterPostCollectionOrder {
  AuthorAsc = 'author_ASC',
  AuthorDesc = 'author_DESC',
  DateAsc = 'date_ASC',
  DateDesc = 'date_DESC',
  LongTitleAsc = 'longTitle_ASC',
  LongTitleDesc = 'longTitle_DESC',
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
...
/** Other content than newsletter cards [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/generalContent) */
export type GeneralContentPageDescriptionArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
...
/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPost = Entry & {
  __typename?: 'NewsletterPost';
  author?: Maybe<Scalars['String']['output']>;
  backgroundColour?: Maybe<Scalars['JSON']['output']>;
  contentfulMetadata: ContentfulMetadata;
...
/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostAuthorArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostBackgroundColourArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostDateArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostLongTitleArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostMainContentArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostPictureArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostPreviewTextArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostSlugArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** This is the main content type to add a new newsletter card [See type definition](https://app.contentful.com/spaces/9j7f50zp5tnd/content_types/newsletterPost) */
export type NewsletterPostTitleArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};

export type NewsletterPostCollection = {
  __typename?: 'NewsletterPostCollection';
  items: Array<Maybe<NewsletterPost>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export type NewsletterPostFilter = {
  AND?: InputMaybe<Array<InputMaybe<NewsletterPostFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<NewsletterPostFilter>>>;
  ...
  longTitle_contains?: InputMaybe<Scalars['String']['input']>;
  longTitle_exists?: InputMaybe<Scalars['Boolean']['input']>;
  longTitle_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  ...
  previewText_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
...
export type NewsletterPostLinkingCollections = {
  __typename?: 'NewsletterPostLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};


export type NewsletterPostLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type Query = {
  ...
  newsletterPost?: Maybe<NewsletterPost>;
  newsletterPostCollection?: Maybe<NewsletterPostCollection>;
};
...
export type QueryNewsletterPostArgs = {
  id: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type QueryNewsletterPostCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<NewsletterPostOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
